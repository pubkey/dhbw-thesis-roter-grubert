...
\begin{center}
	...
	\captionof{figure}[Beispielbild]{Beispielbild - Quelle: Internet}
\end{center}
...
\begin{center}
	...
	\captionof{figure}[Beispielbild2]{Beispielbild2 - Quelle: Internet}
\end{center}
...
\begin{wrapfigure}{r}{0.5\textwidth}\centering
    ...
    \captionof{figure}[Some nice image we have here]{
...
\caption[Schauerleute im Hamburger Hafen- (der text in eckigen Klammern steht dann im Abbildungsverzeichniss)]{
